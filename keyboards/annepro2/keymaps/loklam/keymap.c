...
*/
 ...
 [_BASE_LAYER] = KEYMAP( /* Base */
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_APP, LT(_FN1_LAYER,KC_LEFT), LT(_FN2_LAYER,KC_DOWN), RCTL_T(KC_RGHT)
),
  /*
  * Layer _FN1_LAYER
  * ,-----------------------------------------------------------------------------------------.
  ...
  * |-----------------------------------------------------------------------------------------+
  * | Shift    | ESC | L1  |  e  |  r  |  t  |  y  | PgUp| INS | END | PS | HOME | END |   \    |
  * |-----------------------------------------------------------------------------------------+
  * | FN1     |Ctrl |Shift| Alt |  f  |  g  | LEFT| DOWN|  UP |RIGHT| PGUP|PGDN |    Enter    |
  * |-----------------------------------------------------------------------------------------+
  * | Shift      |  z  |  x  |CapL |  v  |  b  | Bksp| PgDn| DEL |INSRT| DEL |    Shift       |
  * |-----------------------------------------------------------------------------------------+
 ...
 [_FN1_LAYER] = KEYMAP( /* Base */
    ...
    KC_LSFT, KC_ESC, KC_LGUI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_INS, KC_END, KC_PSCR, KC_HOME, KC_END, KC_TRNS,
    KC_TRNS, KC_LCTL, KC_LSFT, KC_LALT, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_PGUP, KC_PGDN, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_CAPS, KC_TRNS, KC_TRNS, KC_BSPC, KC_PGDN, KC_DEL, KC_INS, KC_DEL, KC_TRNS,
